...
Thank you for considering contributing to the `bayt-al-mal`! We appreciate your interest in helping us make this project better. Please take a moment to review these guidelines before submitting your contributions.
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/youzarsiph/bayt-al-mal.git
   cd bayt-al-mal
   ```
...
3. **Running the Application**:
   ...
   ```bash
   poetry run python bayt_al_mal/main.py
   ```
...
If you encounter a bug or have a feature request, please [open an issue](https://github.com/youzarsiph/bayt-al-mal/issues/new). When reporting:
...
By contributing to the `bayt-al-mal`, you agree that your contributions will be licensed under the [MIT License](LICENSE).

## Support

For any questions or assistance, you can:

- Visit the [GitHub Discussions](https://github.com/youzarsiph/bayt-al-mal/discussions).
- Open an issue in the [Issues](https://github.com/youzarsiph/bayt-al-mal/issues) section.
